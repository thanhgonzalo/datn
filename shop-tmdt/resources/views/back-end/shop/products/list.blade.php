                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                @if ($loai !='all')
                                    <a href="{!!url('shops/sanpham/'.$loai.'/add')!!}" title=""><button type="button" class="btn btn-primary pull-right">Thêm Mới Sản Phẩm</button></a>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($data as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{!!url('shops/sanpham/mobile/edit/'.$row->id)!!}" title="Sửa"><span class="glyphicon glyphicon-edit">edit</span> </a>
                                            <a href="{!!url('shops/sanpham/del/'.$row->id)!!}"  title="Xóa" onclick="return xacnhan('Xóa danh mục này ?')"><span class="glyphicon glyphicon-remove">remove</span> </a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
