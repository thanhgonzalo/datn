...
<head>
    ...
    <script type="text/javascript" src="{!! url('public/back-end/js/jquery-1.11.1.min.js') !!}"></script>
    <script type="text/javascript" src="{!! url('public/back-end/js/addproduct.js') !!}"></script>
    <!--Icons-->
