<!-- left menu - menu ben  trai     -->
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="{!!url('admin/shops')!!}"><svg class="glyph stroked mobile device"><use xlink:href="#stroked-mobile-device"/></svg></svg> Shop</a></li>
            <li role="presentation" class="divider"></li>
            <li><a href="{!!url('admin/congno')!!}"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad"/></svg>Công nợ</a></li>
